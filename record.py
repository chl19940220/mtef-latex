...
class TagTypeV3:
    # 所有结构记录的选项标志
    xfLMOVE = 0x8   # nudge values follow tag

    # CHAR 记录的选项标志
    xfAUTO = 0x1    # character is a candidate for function recognition
    xfEMBELL = 0x2  # character is followed by an embellishment list

    # LINE 记录的选项标志
    xfNULL = 0x1    # line is a placeholder only
    xfLSPACE = 0x4  # line spacing value follows tag

    # LINE 和 PILE 记录的选项标志
    xfRULER = 0x2   # RULER record follows LINE or PILE record
